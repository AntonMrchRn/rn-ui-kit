...
export const Input = /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  const currentContainerStyle = StyleSheet.compose(styles.initial, [isFocused ? styles.focused : {}, variant === 'message' ? styles.messageInitial : styles.defaultInitial, containerStyle]);
  const currentInputStyle = StyleSheet.compose(styles.input, [variant !== 'message' && styles.mH, variant === 'message' && numOfLines > 10 && styles.numOfLinesCompanyHeight, style]);
  ...
  }, inputProps)), ['text', 'number'].includes(variant) && isFocused && !!((_props$value2 = props.value) !== null && _props$value2 !== void 0 && _props$value2.length) && /*#__PURE__*/React.createElement(TouchableOpacity, {
    onPress: onClear
