...
export const Input = /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  const currentInputStyle = StyleSheet.compose(styles.input, [variant !== 'message' && styles.mH, variant === 'message' && numOfLinesCompany > 10 && styles.numOfLinesCompanyHeight, style]);
