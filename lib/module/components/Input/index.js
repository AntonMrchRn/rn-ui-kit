...
export const Input = /*#__PURE__*/forwardRef((_ref, ref) => {
  ...
  }, inputProps)), ['text', 'number'].includes(variant) && !!((_props$value = props.value) !== null && _props$value !== void 0 && _props$value.length) && /*#__PURE__*/React.createElement(TouchableOpacity, {
    onPress: onClear
