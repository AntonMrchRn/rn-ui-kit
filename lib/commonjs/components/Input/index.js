...
const Input = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  const [numOfLinesCompany, setNumOfLinesCompany] = (0, _react.useState)(0);
  ...
  const currentInputStyle = _reactNative.StyleSheet.compose(styles.input, [variant !== 'message' && styles.mH, variant === 'message' && numOfLinesCompany > 10 && styles.numOfLinesCompanyHeight, style]);
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNativeReanimated.default.View, {
    ...
    numberOfLines: variant === 'message' ? numOfLinesCompany : undefined,
  ...
  }, inputProps)), ['text', 'number'].includes(variant) && isFocused && !!((_props$value = props.value) !== null && _props$value !== void 0 && _props$value.length) && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    onPress: onClear
