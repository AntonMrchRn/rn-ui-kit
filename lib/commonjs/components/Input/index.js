...
const Input = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  const currentInputStyle = _reactNative.StyleSheet.compose(styles.input, [variant !== 'message' && styles.mH, variant === 'message' && numOfLines > 10 && styles.numOfLinesCompanyHeight, style]);
