...
const InputPhone = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  const styles = _reactNative.StyleSheet.create({
    ...
    prefix: {
      ...
      fontStyle: 'normal',
      fontWeight: '400',
      paddingTop: _reactNative.Platform.OS === 'ios' ? 2 : 0,
      paddingRight: 4
    }
  });
  ...
  }, withRuFlagIcon && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: styles.icon
  ...
  }, props)), isFocused && !!value.length && !disabled && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    onPress: onClear
