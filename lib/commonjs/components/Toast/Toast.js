...
const Toast = _ref => {
  ...
  const currentTitleStyle = _reactNative.StyleSheet.compose(styles.titleHeader, titleStyle);
  ...
  }, secondAction.text)) : /*#__PURE__*/_react.default.createElement(_reactNative.View, null)) : /*#__PURE__*/_react.default.createElement(_reactNative.View, {
