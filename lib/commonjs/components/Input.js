...
const Input = /*#__PURE__*/(0, _react.forwardRef)((_ref, ref) => {
  ...
  const isPasswordDots = !isVisible && variant === 'password' && ((_props$value = props.value) === null || _props$value === void 0 ? void 0 : _props$value.length);
  ...
  }, props)), variant === 'text' && !!((_props$value2 = props.value) !== null && _props$value2 !== void 0 && _props$value2.length) && /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, {
    onPress: onClear
