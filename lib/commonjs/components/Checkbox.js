...
const CheckBox = _ref => {
  ...
  const style = _reactNative.StyleSheet.compose(stylesCheckBox.initial, [props.style, currentStyle()]);
  return /*#__PURE__*/_react.default.createElement(_reactNative.TouchableOpacity, _extends({
    style: style
  }, props, {
    activeOpacity: 0.7
  }), props.checked && (icon ? icon : /*#__PURE__*/_react.default.createElement(_CheckBoxIcon.CheckBoxIcon, null)));
};
