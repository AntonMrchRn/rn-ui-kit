...
- Исправлены стили компонента SegmentedControl

### 1.2.3

- Добавлен пропс компоненту InputPhone
...
- Добавлен новый тип компонента Input
...
- Изменения логики взаимодействия с компонентом TabControl
...
- Исправлен параметр fontWeight на платформе андроид
...
- Добавлена опциональность для пропса iconSize компонента Banner

### 0.3.12

- Добавлен пропс iconSize компоненту Banner
- Исправлены стили компонента Banner

### 0.3.11

- Добавлено свойство numberOfLines для текста компонента Chips

### 0.3.10

- Исправлены стили компонентов Input, InputPhone
- Добавлено свойство collapsable для компонента Tooltip
